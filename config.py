...
When running as a frozen exe (PyInstaller), user data (DB, logs, reports,
backups) is redirected to %LOCALAPPDATA%\\SportsManager so the install
folder under Program Files can stay read-only.
"""
...
REPORTS_DIR: Path = DATA_DIR / os.environ.get("REPORTS_DIR", "reports")
